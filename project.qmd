...
Write a function that will, given a dataframe, group by a column and the count 
...
Apply this function to the math dataset to prove that it works. Group by address
