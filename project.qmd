...
**1.** How could you write code to clean the dataset as outlined above? (drop columns not included yet as noted)
...
**3.** Using your joined dataset, create a new variable `g3_diff` that represents
...
**4.** Write a function that will, given a dataframe, group by a column and the count 
...
**5.**Apply this function to the math dataset to prove that it works. Group by address
