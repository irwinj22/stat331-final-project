...
**4a.** Write a function that will, given a dataframe, group by a column and the count 
...
**4b.**Apply this function to the math dataset to prove that it works. Group by address
