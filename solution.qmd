---
title: "Solutions: Performance in Portugal"
...
Yes, it does appear that there is a difference between Rural and Urban student
performance since Urban students outperform Rural students across both subjects.
...
Yes, the data appears to be normally distributed.
...
Create a summary table for both, and then write a sentence or two about each
model.
...
There is a weak, negative, linear relationship between going out with friends
and math performance for students in this dataset.

There is a weak, positive, linear relationship between time spent studying and
math performance for students in this dataset.
...
tibble(
  ...
  kable(col.names = c("Split", "R-squared"),
        digits = 4) |> 
  kableExtra::kable_styling(full_width = FALSE,
                            bootstrap_options = "condensed")
```
